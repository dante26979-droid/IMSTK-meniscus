...
if(DEFINED ${PROJECT_NAME}_VTK_ARCHIVE)
  set(${PROJECT_NAME}_VTK_SOURCE
    URL ${${PROJECT_NAME}_VTK_ARCHIVE}
    )
  if(DEFINED ${PROJECT_NAME}_VTK_ARCHIVE_MD5)
    list(APPEND ${PROJECT_NAME}_VTK_SOURCE
      URL_HASH MD5=${${PROJECT_NAME}_VTK_ARCHIVE_MD5}
      )
  endif()
  set(${PROJECT_NAME}_VTK_HASH)
elseif(DEFINED ${PROJECT_NAME}_VTK_GIT_REPOSITORY)
  set(${PROJECT_NAME}_VTK_SOURCE GIT_REPOSITORY ${${PROJECT_NAME}_VTK_GIT_REPOSITORY})
else()
...
if(DEFINED ${PROJECT_NAME}_VTK_ARCHIVE)
  set(${PROJECT_NAME}_VTK_HASH)
elseif(${PROJECT_NAME}_VTK_REPO_SOURCE EQUAL "9.1")
...
imstk_add_external_project( VTK
  ...
  PATCH_COMMAND ${CMAKE_COMMAND} -DVTK_SOURCE_DIR=<SOURCE_DIR> -P ${CMAKE_CURRENT_LIST_DIR}/Patch_VTK.cmake
  CMAKE_ARGS
       ${VTK_MODULE_SETTINGS}
